...
import { addRangeSliders, checkAllFilters } from './components/filter';
import './global.scss';

	export const basketPay = new Basket()
	addRangeSliders()
  checkAllFilters()
...
// 		- блок фильтров сделан опцианальным, можно выдвинуть или спрятать, есть скидки и сортировка реализована с учетом них, в карточках дополнительная информация появляется при наведении на карточку, в корзине можно увидеть какой товар выбран и общюю стоимость. +20 
// `)