...
export const FilterCheckets = [
	{
			'Color': ['Black', 'Cyan', 'Green', 'Grey', 'Pink', 'White', 'Blue', 'Red', 'Brown', 'Orange', 'Multicolor', 'Beige', 'Vinous', 'Yellow',]
	},
	{
			'Size': ['XL', 'L', 'M', 'S', 'Xs',]
	},
	...
	{
			'Price': ['$1200+', '$600-$1200', '$300-$600', '$150-$300', '$50-$150', '$7-$50']
	}
]
...
export interface IProducts{
	men: IProductDiscription[];
	women: IProductDiscription[];
}
